        ...
        <Body className="bg-gray-100 py-[40px] font-sans">
          <Container className="mx-auto max-w-[600px] rounded-[8px] bg-white p-[20px]">
            ...
            <Text className="mb-[24px] text-[16px] leading-[24px] text-gray-600">
              Thanks for signing up for Ponovo! Before you start tracking your
              applications, please verify your email address by clicking the
              button below. This link will expire in 1 hour.
            </Text>
